...
!(function (D, u) {
  ...
  function C(D, u, e, F, C, i, n) {
        ...
        ((d = (o = l[E]).parentNode === D) || G || (q && !P)) &&
          ...
          k &&
            (((o._isSplit && d) ||
              (!q && d) ||
              (P && d) ||
              (!P && o.parentNode.parentNode === D && !o.parentNode._isSplit)) &&
        ...
        for (
          a = k[E],
            (c = Q.createElement(M)).style.cssText =
              'display:block;text-align:' + O + ';position:' + (G ? 'absolute;' : 'relative;'),
          ...
          'BR' !== a[s].nodeName &&
            ...
            G &&
              (0 === s && ((c.style.top = o._y + 'px'), (c.style.left = w + m + 'px')),
              (o.style.top = '0px'),
    ...
    G &&
      (n > D.clientHeight &&
        ((D.style.height = n - T + 'px'), D.clientHeight < n && (D.style.height = n + b + 'px')),
      i > D.clientWidth &&
        ((D.style.width = i - N + 'px'), D.clientWidth < i && (D.style.width = i + _ + 'px'))),
      y(e, W),
      P && y(F, H),
      y(C, V)
  }
      ...
      if (((o = i.charAt(E)), g && (d = g(i.substr(E), e.specialChars))))
        ...
        '{' === o && '{{LT}}' === i.substr(E, 6)
          ...
          ? ((s = ((i.substr(E, 12).split(v) || [])[1] || '').length || 2),
            (n += p && ' ' !== o ? C() + i.substr(E, s) + '</' + a + '>' : i.substr(E, s)),
            (E += s - 1))
          : (n += p && ' ' !== o ? C() + o + '</' + a + '>' : o)
